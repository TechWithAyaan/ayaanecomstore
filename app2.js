  ...
  document.getElementsByClassName("count")[0].innerHTML = num
      ...
      var productname = ["Shan Dawat Masla Bundle","Dawlance Washing Machine"]
      var product1 = document.getElementsByClassName("card-title")[0].innerHTML = productname[0];
      var product1 = document.getElementsByClassName("card-title-2")[0].innerHTML = productname[1];
      var allCards = document.getElementsByClassName("allCard");
      var abc = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";

    function search(){
          var userSearch = prompt("Search Product");
      if(userSearch.toString().toLowerCase() == productname[0].toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
      //  document.getElementsByClassName("card-1-1")[0].style.margin = "20px"
      }
      else if(userSearch.toString().toLowerCase() == "Shan".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
      }
      else if(userSearch.toString().toLowerCase() == "Shan Masala".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
      }
      else if(userSearch.toString().toLowerCase() == "Masala".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
      ...
      if(userSearch.toString().toLowerCase() == productname[1].toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-2")[0].style.display = "flex"
      document.getElementsByClassName("card-1-")[0].style.margin = "20px"
      }
            else if(userSearch.toString().toLowerCase() == "Washing Machine".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-2")[0].style.display = "flex"
      }
      else if(userSearch.toString().toLowerCase() == "Wash".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-2")[0].style.display = "flex"
      }
      else if(userSearch.toString().toLowerCase() == "Machine".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
      }
      else if(userSearch.toString().toLowerCase() == "Dawlance".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
      }
      else if(userSearch.toString().toLowerCase() == "Washing Product".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
      }
      else if(userSearch.toString().toLowerCase() == "Washing Machine in low price".toLowerCase()){
        for(var i = 0;i < allCards.length;i++){
  allCards[i].style.display = "none"
        }
      document.getElementsByClassName("card-1-1")[0].style.display = "flex"
  ...
  // let num = parseInt(document.querySelector(".count").innerText); // start from the HTML number
  ...
  // function min() {
  //     if(num > 1) { // optional: prevent going below 1
  //         num--;
  //         document.querySelector(".count").innerText = num;
  //     }
  // }
